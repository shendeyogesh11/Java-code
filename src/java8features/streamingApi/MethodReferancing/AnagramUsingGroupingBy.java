...
public class AnagramUsingGroupingBy {
	...
	public static void main(String[] args) {
		...
		Map<String, List<String>> map = months.stream().collect(Collectors.groupingBy(mon ->{
			 
			char[] arr = mon.toCharArray();
			Arrays.sort(arr);
		...
		Map<String, Long> map1 = months.stream().collect(Collectors.groupingBy(mon ->{
